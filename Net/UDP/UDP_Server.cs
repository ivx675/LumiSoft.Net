    ...
    {      
            ...
            if(m_pBindings != null){
                ...
                foreach(Socket socket in m_pSockets){
                    if (socket.LocalEndPoint == null) {
                        throw new ArgumentException("Socket LocalEndPoint is null, should never happen.");
                    }
        ...
        public void SendPacket(IPEndPoint localEP,byte[] packet,int offset,int count,IPEndPoint remoteEP)
        {
            ...
            if(localEP.AddressFamily == AddressFamily.InterNetwork){
                if(m_pSendSocketsIPv4 != null){
                    foreach(Socket s in m_pSendSocketsIPv4.ToArray()){
                        if(localEP.Equals(s.LocalEndPoint as IPEndPoint)){
                            socket = s;
                            break;
                        }
                    }
        ...
        internal void SendPacket(Socket? socket,byte[] packet,int offset,int count,IPEndPoint remoteEP,out IPEndPoint localEP)
        {
            ...
            if(socket == null){
                ...
                if(remoteEP.AddressFamily == AddressFamily.InterNetwork){
                    if(m_pSendSocketsIPv4 == null || m_pSendSocketsIPv4.Count == 0){
                    ...
                    if(m_pSendSocketsIPv6 == null || m_pSendSocketsIPv6.Count == 0){
        ...
        public IPEndPoint GetLocalEndPoint(IPEndPoint remoteEP)
        {
            ...
            if(remoteEP.AddressFamily == AddressFamily.InterNetwork){
                ...
                IPEndPoint? localIPEndpoint = m_pSendSocketsIPv4.Next()?.LocalEndPoint as IPEndPoint;
                if(localIPEndpoint == null){
                    throw new InvalidOperationException("LocalEndPoint is null, should never happen.");
                }
                ...
                IPEndPoint? iPEndPoint = m_pSendSocketsIPv6.Next()?.LocalEndPoint as IPEndPoint;
                if(iPEndPoint == null){
                    throw new InvalidOperationException("LocalEndPoint is null, should never happen.");
                }
