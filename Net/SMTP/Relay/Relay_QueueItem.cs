...
namespace LumiSoft.Net.SMTP.Relay
{
    ...
    public class Relay_QueueItem
    {
        ...
        private SMTP_t_DSN_Ret    m_DSN_Ret           = SMTP_t_DSN_Ret.NotSpecified;
        private string            m_To                = "";
        private string?           m_OriginalRecipient = null;
        private SMTP_t_DSN_Notify m_DSN_Notify        = SMTP_t_DSN_Notify.NotSpecified;
        ...
        internal Relay_QueueItem(Relay_Queue queue,Relay_SmartHost? targetServer,string from,string? envelopeID,SMTP_t_DSN_Ret ret,string to,string? originalRecipient,SMTP_t_DSN_Notify notify,string messageID,Stream message,object? tag)
        {
            m_pQueue            = queue;
        ...
        /// <summary>
        /// Gets DSN ENVID value. Value null means not specified.
        /// </summary>
        ...
        /// <summary>
        /// Gets DSN ORCPT value. Value null means not specified.
        /// </summary>
        ...
        /// </summary>
        public SMTP_t_DSN_Notify DSN_Notify
        {
