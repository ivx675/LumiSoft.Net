...
namespace LumiSoft.Net.SMTP.Relay
{
    ...
    public class Relay_Queue : IDisposable
    {
        ...
        {
            QueueMessage(null,from,null,SMTP_t_DSN_Ret.NotSpecified,to,null,SMTP_t_DSN_Notify.NotSpecified,messageID,message,tag);
        }
        ...
        /// <exception cref="ArgumentNullException">Is raised when <b>to</b>,<b>to</b>,<b>messageID</b> or <b>message</b> is null.</exception>
        /// <exception cref="ArgumentException">Is raised when any of the arguments has invalid value.</exception>
        public void QueueMessage(string from,string? envelopeID,SMTP_t_DSN_Ret ret,string to,string? originalRecipient,SMTP_t_DSN_Notify notify,string messageID,Stream message,object? tag)
        {
        ...
        /// <exception cref="ArgumentNullException">Is raised when <b>to</b>,<b>to</b>,<b>messageID</b> or <b>message</b> is null.</exception>
        /// <exception cref="ArgumentException">Is raised when any of the arguments has invalid value.</exception>
        public void QueueMessage(Relay_SmartHost? targetServer,string from,string? envelopeID,SMTP_t_DSN_Ret ret,string to,string? originalRecipient,SMTP_t_DSN_Notify notify,string messageID,Stream message,object? tag)
        {
            if(messageID == null){
