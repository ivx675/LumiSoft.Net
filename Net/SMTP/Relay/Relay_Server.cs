...
namespace LumiSoft.Net.SMTP.Relay
{
    ...
    public class Relay_Server : IDisposable
    {
        ...
        {
            try{
                ArgumentNullException.ThrowIfNull(this.Sessions);
        ...
        private void Run()
        {
            ArgumentNullException.ThrowIfNull(m_pLocalEndPointIPv4);
            ArgumentNullException.ThrowIfNull(m_pLocalEndPointIPv6);
            ArgumentNullException.ThrowIfNull(m_pSessions);
        ...
        internal bool TryAddIpUsage(IPAddress ip)
        {
            ...
            ArgumentNullException.ThrowIfNull(m_pConnectionsPerIP);
