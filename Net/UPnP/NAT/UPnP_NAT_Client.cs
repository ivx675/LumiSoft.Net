...
namespace LumiSoft.Net.UPnP.NAT
{
    ...
    public class UPnP_NAT_Client
    {
                    ...
                    foreach(NetworkInterface adapter in NetworkInterface.GetAllNetworkInterfaces()){
                        if(adapter.OperationalStatus == OperationalStatus.Up){
                            foreach(GatewayIPAddressInformation gwInformation in adapter.GetIPProperties().GatewayAddresses){
                                devices = client.Search(gwInformation.Address,"urn:schemas-upnp-org:device:InternetGatewayDevice:1",1200);
                                break;
                            }
                            break;
                        }
        ...
        /// </summary>
        /// <returns>Returns NAT public IP address or null if fails.</returns>
            ...
            */
            ...
            for(int i=0;i<100;i++){
                try{
                    ...
                    if(x.Response != null && x.Response.ContentType != null && x.Response.ContentType.ToLower().IndexOf("text/xml") > -1){
        ...
        public void AddPortMapping(bool enabled,string description,string protocol,string remoteHost,int publicPort,IPEndPoint localEP,int leaseDuration)
        {
            ...
            */
            ...
            try{
                ...
                // We have UPnP exception.
                if(x.Response != null && x.Response.ContentType.ToLower().IndexOf("text/xml") > -1){
