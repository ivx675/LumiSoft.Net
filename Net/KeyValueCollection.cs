...
namespace LumiSoft.Net
{
    ...
    /// </summary>
    public class KeyValueCollection<K,V> : IEnumerable<V>, IEnumerable where K : notnull
    {
        private readonly Dictionary<K,V> m_pDictionary = new Dictionary<K,V>();
        private readonly List<V>         m_pList       = new List<V>();
