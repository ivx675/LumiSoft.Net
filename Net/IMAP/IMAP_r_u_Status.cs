    ...
    public class IMAP_r_u_Status : IMAP_r_u
    {
        ...
        public static IMAP_r_u_Status Parse(string response)
        {
            ...
            */
            ...
            string? folder = r.ReadWord();
            if(folder == null){
                throw new ParseException("Parse error: Invalid STATUS response, mailbox name is missing.");
            }
            folder = TextUtils.UnQuoteString(IMAP_Utils.Decode_IMAP_UTF7_String(folder));
