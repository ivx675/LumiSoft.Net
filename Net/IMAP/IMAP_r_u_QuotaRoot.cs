    ...
    public class IMAP_r_u_QuotaRoot : IMAP_r_u
    {
        ...
        public static IMAP_r_u_QuotaRoot Parse(string response)
        {
            ...
            */
            ...
            string? folderName = r.ReadWord();
            if(folderName == null){
                throw new ArgumentException("Invalid QUOTAROOT response, mailbox name is missing.","response");
            }
            folderName = TextUtils.UnQuoteString(IMAP_Utils.Decode_IMAP_UTF7_String(folderName));
