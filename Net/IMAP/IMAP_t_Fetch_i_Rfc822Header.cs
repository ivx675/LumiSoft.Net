...
{
    /// <summary>
    /// Represents the IMAP <c>RFC822.HEADER</c> FETCH request data‑item as
    /// defined in RFC 3501 section 7.4.2. When included in a FETCH command,
    /// this attribute instructs the server to return the message header
    /// section only, excluding the message body.
    /// </summary>
    public class IMAP_t_Fetch_i_Rfc822Header : IMAP_t_Fetch_i
    {
        ...
        /// <para>
        /// For <c>RFC822.HEADER</c>, the string representation is always the
        /// literal <c>"RFC822.HEADER"</c>, which is inserted directly into the
