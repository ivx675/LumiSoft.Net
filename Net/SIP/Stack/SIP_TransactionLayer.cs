...
namespace LumiSoft.Net.SIP.Stack
{
    ...
    {        
        ...
        public SIP_Dialog GetOrCreateDialog(SIP_Transaction transaction,SIP_Response response)
        {
            ...
            if(response.To == null){
                throw new ArgumentException("SIP response 'To' header is missing.");
            }
            if(response.From == null) {
                throw new ArgumentException("SIP response 'From' header is missing.");
            }
            if(response.CSeq == null) {
                throw new ArgumentException("SIP response 'CSeq' header is missing.");
            }
