...
namespace LumiSoft.Net.SIP.Stack
{
    ...
    public class SIP_Request : SIP_Message
    {
        ...
        public void Validate()
        {
            ...
            var via = this.Via.GetTopMostValue();
            if(via == null){
            ...
            */
            if(SIP_Utils.MethodCanEstablishDialog(this.RequestLine.Method)){
                ...
                if(!this.Contact.GetAllValues()[0].Address.IsSipOrSipsUri){
        ...
        public static SIP_Request Parse(Stream stream)
        {
            ...
            */
            ...
            string? responseLine = r.ReadLineString();
            if(responseLine == null) {
                throw new Exception("Invalid SIP request data, Request-Line is missing.");
            }
            string[] method_uri_version = responseLine.Split(' ');
