    ...
    public class SIP_ClientTransaction : SIP_Transaction
    {
            ...
            */
            ...
            lock(this.SyncRoot){
                if(this.State == SIP_TransactionState.Calling){
                    ...
                    ArgumentNullException.ThrowIfNull(m_pTimerA);
            ...
            */
            ...
            lock(this.SyncRoot){
                if(this.State == SIP_TransactionState.Trying){
                    ...
                    // Update(double current) next transmit time.
                    ArgumentNullException.ThrowIfNull(m_pTimerE);
        ...
        private void SendCancel()
        {
            ...
            */
            ...
            var topMostVia = this.Request.Via.GetTopMostValue();
            if(topMostVia == null){
                throw new ArgumentException("Request has no required Via header field value.");
            }
            if (this.Request.CSeq == null) {
                throw new ArgumentException("Request has no required CSeq header field value.");
            }

            SIP_Request cancelRequest = new SIP_Request(SIP_Methods.CANCEL);
            cancelRequest.RequestLine.Uri = this.Request.RequestLine.Uri;
            cancelRequest.Via.Add(topMostVia.ToStringValue());
        ...
        private void SendAck(SIP_Response response)
        {
            ...
            */
            ...
            ackRequest.Via.AddToTop(topMostVia.ToStringValue());
