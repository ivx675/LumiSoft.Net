...
namespace LumiSoft.Net.FTP.Server
{
	...
	public class FTP_Session : TCP_ServerSession
    {
        ...
        private class DataConnection
        {
            ...
            public void Start()
            {
                ...
                if(m_pSession.PassiveMode){
                    ArgumentNullException.ThrowIfNull(m_pSession.m_pPassiveSocket);
                    ArgumentNullException.ThrowIfNull(m_pSession.m_pPassiveSocket.LocalEndPoint);
                ...
                // Active mode, connect to client data port.
                    ...
                    ArgumentNullException.ThrowIfNull(m_pSession.m_pDataConEndPoint);
                    ArgumentNullException.ThrowIfNull(m_pSession.LocalEndPoint);
        ...
        public FTP_Session()
        {
            m_pAuthentications = new Dictionary<string,AUTH_SASL_ServerMechanism>(StringComparer.InvariantCultureIgnoreCase);
        }
		...
		private void PASV(string argsText)
		{
            ...
            ArgumentNullException.ThrowIfNull(this.LocalEndPoint);
			...
			*/
            ...
            if(m_pPassiveSocket != null){
                ArgumentNullException.ThrowIfNull(m_pPassiveSocket.LocalEndPoint);

                // DO nothing ... Use existing socket.
                port = ((IPEndPoint)m_pPassiveSocket.LocalEndPoint).Port;
            }
        ...
        /// <summary>
        /// Gets number of bad commands happened on FTP session.
        /// </summary>
        /// <exception cref="ObjectDisposedException">Is raised when this object is disposed and this property is accessed.</exception>
