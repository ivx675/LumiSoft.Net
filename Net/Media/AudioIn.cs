    ...
    public class AudioIn : Stream
    {
        ...
        private class WaveIn
        {
            ...
            private class BufferItem
            {
                ...
                public WAVEHDR Header
                {
                    get{
                        if(m_HeaderHandle.Target == null) {
                            throw new Exception("Failed to retrieve wave header.");
                        }
                ...
                {
                    get{
                        if(m_DataHandle.Target == null) {
                            throw new Exception("Failed to retrieve wave handle.");
                        }
            ...
            {   
                ...
                lock(m_pLock){
                    try{
                        ArgumentNullException.ThrowIfNull(m_pCurrentBuffer);
