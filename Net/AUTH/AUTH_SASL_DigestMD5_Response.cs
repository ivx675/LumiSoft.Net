...
namespace LumiSoft.Net.AUTH
{
    ...
    public class AUTH_SASL_DigestMD5_Response
    {
        ...
        /// <param name="realm">Realm value. This must be one value of the client challenge Realm.</param>
        ...
        /// <summary>
        /// Gets charset value. Value null means not specified.
        /// </summary>
        ...
        /// <summary>
        /// Gets cipher value. Value null means not specified.
        /// </summary>
        ...
        /// <summary>
        /// Gets authorization ID. Value null means not specified.
        /// </summary>
