...
{    
    ...
    {
        private Dictionary<string,object> m_pTags = new Dictionary<string, object>();
        ...
        /// <returns>Returns challenge response what must be sent to client or null if authentication has completed.</returns>
