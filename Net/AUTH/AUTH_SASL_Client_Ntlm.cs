...
namespace LumiSoft.Net.AUTH
{
    ...
    public class AUTH_SASL_Client_Ntlm : AUTH_SASL_Client
    {
        ...
        /// <returns>Returns challenge request what must be sent to server.</returns>
            ...
            */
            ...
            if(m_State == 0){
                ...
                if(serverResponse == null){
                    throw new ArgumentNullException("serverResponse","Server response cannot be null in auth state 2.");
                }
                m_State++;
                m_IsCompleted = true;
